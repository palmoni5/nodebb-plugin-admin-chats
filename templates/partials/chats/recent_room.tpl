	...
	<div class="d-flex gap-1 justify-content-between">
		<a href="#" class="chat-room-btn position-relative d-flex flex-grow-1 gap-2 justify-content-start align-items-start btn btn-ghost btn-sm ff-sans text-start">
			...
			<div class="d-flex flex-grow-1 flex-column w-100">
				...
				<div class="admin-chat-participants text-muted text-xs text-break line-clamp-2"><span class="fw-semibold">{{tx("admin-chats:participants")}}:</span> {./participantsLabel}</div>
				{{{ end }}}
			</div>
		</a>
		{{{ if !adminAllChats }}}
